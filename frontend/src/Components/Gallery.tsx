  ...
  return (
    <div className="shadow-lg text-white object-top relative">
      ...
      <div className="absolute inset-0 bg-cover bg-center z-0">
        <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-3xl text-greeny font-semibold hover:backdrop-blur-sm filter backdrop-sepia">
